...
# button (
#button_bak = Button(text='(',font=('mystyle',20))
#button_bak.pack(side='left',padx=58,pady=180)
#button_bak.place(x='80',y='465')
#button_bak.bind('<Button-1>',click)
# button )
#button_bal = Button(text=')',font=('mystyle',20))
#button_bal.pack(side='left',padx=18,pady=180)
#button_bal.place(x='250',y='465')
#button_bal.bind('<Button-1>',click)
app.mainloop()
